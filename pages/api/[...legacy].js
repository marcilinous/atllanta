...
// and the 10 legacy handlers keep their exact (req, res) signature.
const handlers = {
...
export default async function handler(req, res) {
  ...
  // Own keys only: a bare lookup would also match "constructor", "__proto__"…
  const load = Object.hasOwn(handlers, name) ? handlers[name] : undefined;
