...
export default async function crmHub(container) {
  ...
  const partnerCards = [
    ...
    { title: 'Who to visit', feature: 'crm_to_visit', desc: 'Partners needing attention, biggest business first', route: 'crm/to-visit', color: 'var(--color-error)', icon: 'M13 2L3 14h8l-1 8 10-12h-8l1-8z' },
    { title: 'Journey plan', feature: 'crm_pjp', desc: 'Plan the month day by day, by area', route: 'crm/pjp', color: 'var(--color-info)', icon: 'M8 2v4M16 2v4M3 10h18M5 4h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z' },
