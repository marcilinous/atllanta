...
export default async function crmHub(container) {
  ...
  container.innerHTML = `
    <div class="page-header">
      ...
      <p class="page-subtitle">Your Tally partners — coverage, visits, targets and sales</p>
    </div>
  ...
  // Primary — the workflows RT runs day to day.
  const primary = [
    { title: 'Partners', desc: 'Your Tally partner base, by region & role', route: 'crm/accounts', color: 'var(--color-info)', icon: 'M3 21h18M5 21V7l8-4v18M19 21V11l-6-3M9 9v.01M9 12v.01M9 15v.01M9 18v.01' },
    { title: 'My targets', desc: 'Where to do business — partners ranked', route: 'crm/targets', color: 'var(--color-error)', icon: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zM12 6a6 6 0 1 0 0 12 6 6 0 0 0 0-12zM12 10a2 2 0 1 0 0 4 2 2 0 0 0 0-4z' },
    { title: 'Log a visit', desc: 'Record a partner visit with GPS & selfie', route: 'crm/visits', color: 'var(--color-success)', icon: 'M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0zM12 7a3 3 0 1 0 0 6 3 3 0 0 0 0-6z' },
    { title: 'Telecalling', desc: 'Your call book — TSS renewals to drive', route: 'crm/telecalling', color: 'var(--color-warning)', icon: 'M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.9.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z' },
    { title: 'Opportunities', desc: 'TP & TSS gaps to drive, by team', route: 'crm/opps', color: 'var(--color-accent)', icon: 'M3 3v18h18M18 9l-5 5-3-3-4 4' },
    { title: 'Business by territory', desc: 'Revenue, TP/TSS & coverage: CM → TL → BDE', route: 'crm/coverage', color: 'var(--color-accent)', icon: 'M22 12h-4l-3 9L9 3l-3 9H2' },
    { title: 'Sales', desc: 'Activation revenue by product, channel & area', route: 'crm/sales', color: 'var(--color-success)', icon: 'M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6' },
  ...
  // RT-relevant KPIs from the partner activity rollup (same source as
  // My Targets / Coverage, so the numbers agree).
  ...
  try {
    ...
    // Fall back to a plain partner count if the rollup is unavailable.
