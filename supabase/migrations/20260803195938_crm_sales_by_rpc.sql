-- Activation/sales aggregation, pivotable by a chosen partner dimension.
-- Channel: distribution-partner-billed ex-Kerala = RTcompu; Kerala = separate;
-- everything else = Online. Category: TSS / TP (new) / TPCA (TPCloud New only)
-- / WABA (WhatsApp New) / Other. Scoped to the caller's visibility.
